...
"""
This program uses the Euler method to solve for the motion of a ball dropped 
from rest close to the surface of Earth. The program depends on the function 
VelocityLinearDrag to execute the Euler method. 
"""
...
try:
	...
	dt = [float(sys.argv[5]), float(sys.argv[6])]# time step
except:
	print "Usage:", sys.argv[0], "outfile vinitial vterminal tmax dt1 dt2"
	sys.exit(1)
